...
export const WORLD_CONFIGS: Record<WorldKey, WorldConfig> = {
  cognition: {
    ...
    chapters: [
      { key: 'focus', label: '집중력', icon: '🎯', color: 'from-violet-500 to-purple-600', gradient: 'from-violet-500/20 to-purple-500/20' },
      { key: 'understanding', label: '이해력', icon: '💡', color: 'from-blue-500 to-cyan-600', gradient: 'from-blue-500/20 to-cyan-500/20' },
      { key: 'memory', label: '기억력', icon: '🧩', color: 'from-green-500 to-emerald-600', gradient: 'from-green-500/20 to-emerald-500/20' },
      { key: 'thinking', label: '사고력', icon: '🔮', color: 'from-pink-500 to-rose-600', gradient: 'from-pink-500/20 to-rose-500/20' },
      { key: 'creativity', label: '창의력', icon: '🎨', color: 'from-amber-500 to-orange-600', gradient: 'from-amber-500/20 to-orange-500/20' },
      { key: 'problem', label: '문제해결', icon: '🔧', color: 'from-red-500 to-rose-600', gradient: 'from-red-500/20 to-rose-500/20' },
      { key: 'analysis', label: '분석력', icon: '📊', color: 'from-indigo-500 to-blue-600', gradient: 'from-indigo-500/20 to-blue-500/20' },
      { key: 'metacog', label: '메타인지', icon: '🪞', color: 'from-teal-500 to-cyan-600', gradient: 'from-teal-500/20 to-cyan-500/20' },
    ]
  },
  selfDirected: {
    key: 'selfDirected',
