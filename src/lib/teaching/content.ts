...
export const TEACHING_CONTENTS: TeachingContent[] = [
  ...
  // ===== 표현 월드 =====
  // 말하기
  { id: 'relationship-speaking-1-1', worldKey: 'relationship', chapterKey: 'speaking', level: 1, conceptTitle: '명확하게 말하기', conceptContent: '좋은 말하기는 명확함입니다.\n\n결론부터, 핵심만, 간단하게 말하세요.\n\n복잡하게 말하면 상대가 이해하기 어렵습니다.', thinkingQuestion: '말할 때 핵심을 잘 전달하나요?', actionMission: '오늘 할 말을 한 문장으로 정리한 후 말하기', xpReward: 10, energyReward: 3 },
  { id: 'relationship-speaking-1-2', worldKey: 'relationship', chapterKey: 'speaking', level: 1, conceptTitle: '상대를 생각하며 말하기', conceptContent: '듣는 사람 입장에서 생각하세요.\n\n상대가 알아들을 수 있게, 관심 있어 할 내용으로 말하세요.\n\n같은 말도 대상에 따라 다르게 하세요.', thinkingQuestion: '상대방 입장에서 말하려고 하나요?', actionMission: '상대가 이해하기 쉽게 설명하기', xpReward: 10, energyReward: 3 },
  { id: 'relationship-speaking-1-3', worldKey: 'relationship', chapterKey: 'speaking', level: 1, conceptTitle: '자신감 있게 말하기', conceptContent: '자신감은 목소리에서 드러납니다.\n\n똑바로 보고, 적당한 크기로, 천천히 말하세요.\n\n자신감 있게 말하면 더 설득력이 생깁니다.', thinkingQuestion: '말할 때 자신감이 있나요?', actionMission: '눈을 보며 또박또박 말하기', xpReward: 10, energyReward: 3 },

  // 글쓰기
  { id: 'relationship-writing-1-1', worldKey: 'relationship', chapterKey: 'writing', level: 1, conceptTitle: '글쓰기의 기초', conceptContent: '좋은 글의 시작은 한 문장입니다.\n\n내가 전하고 싶은 핵심을 한 문장으로 적어보세요.\n\n그 문장을 중심으로 살을 붙이세요.', thinkingQuestion: '글 쓸 때 어디서부터 시작하나요?', actionMission: '오늘 느낀 점을 한 문장으로 적기', xpReward: 10, energyReward: 3 },
  { id: 'relationship-writing-1-2', worldKey: 'relationship', chapterKey: 'writing', level: 1, conceptTitle: '구조 잡기', conceptContent: '좋은 글은 구조가 있습니다.\n\n서론-본론-결론, 또는 문제-원인-해결\n\n구조를 먼저 잡으면 글쓰기가 쉬워집니다.', thinkingQuestion: '글 쓸 때 구조를 생각하나요?', actionMission: '짧은 글의 구조 3단계로 잡기', xpReward: 10, energyReward: 3 },
  { id: 'relationship-writing-1-3', worldKey: 'relationship', chapterKey: 'writing', level: 1, conceptTitle: '고쳐쓰기', conceptContent: '좋은 글은 고쳐쓰기에서 나옵니다.\n\n첫 번째 초안은 완벽할 필요 없습니다.\n\n쓰고 나서 다듬으세요.', thinkingQuestion: '쓴 글을 다시 읽어보나요?', actionMission: '쓴 글 다시 읽고 한 부분 고치기', xpReward: 10, energyReward: 3 },

  // 경청
  { id: 'relationship-listening-1-1', worldKey: 'relationship', chapterKey: 'listening', level: 1, conceptTitle: '듣기의 힘', conceptContent: '좋은 대화는 잘 듣는 것에서 시작됩니다.\n\n말하는 것보다 듣는 게 더 중요합니다.\n\n상대방의 말에 집중하세요.', thinkingQuestion: '대화할 때 상대 말에 집중하나요?', actionMission: '대화 중 끝까지 듣고 나서 말하기', xpReward: 10, energyReward: 3 },
  { id: 'relationship-listening-1-2', worldKey: 'relationship', chapterKey: 'listening', level: 1, conceptTitle: '공감하며 듣기', conceptContent: '들으면서 상대의 감정을 느껴보세요.\n\n"그랬구나", "그래서 어땠어?"라고 반응하세요.\n\n공감받으면 더 말하고 싶어집니다.', thinkingQuestion: '상대의 감정에 공감하며 듣나요?', actionMission: '대화 중 공감 표현 3번 하기', xpReward: 10, energyReward: 3 },
  { id: 'relationship-listening-1-3', worldKey: 'relationship', chapterKey: 'listening', level: 1, conceptTitle: '질문하며 듣기', conceptContent: '질문은 관심의 표현입니다.\n\n"그건 어떻게 된 거야?", "왜 그랬어?"라고 물어보세요.\n\n상대가 더 이야기하고 싶어집니다.', thinkingQuestion: '대화 중 질문을 많이 하나요?', actionMission: '대화 중 질문 2개 이상 하기', xpReward: 10, energyReward: 3 },

  // 비언어 표현
  { id: 'relationship-nonverbal-1-1', worldKey: 'relationship', chapterKey: 'nonverbal', level: 1, conceptTitle: '몸짓 언어', conceptContent: '말보다 몸짓이 더 많은 걸 전달합니다.\n\n표정, 자세, 손짓 모두 메시지입니다.\n\n말과 몸짓이 일치하면 더 신뢰가 갑니다.', thinkingQuestion: '말할 때 몸짓을 의식하나요?', actionMission: '대화 중 자세와 표정 신경 쓰기', xpReward: 10, energyReward: 3 },
  { id: 'relationship-nonverbal-1-2', worldKey: 'relationship', chapterKey: 'nonverbal', level: 1, conceptTitle: '눈 맞춤', conceptContent: '눈을 맞추면 신뢰가 생깁니다.\n\n피하면 자신 없어 보이고, 노려보면 위협적입니다.\n\n자연스럽게 3초 정도 보세요.', thinkingQuestion: '대화 중 눈을 잘 맞추나요?', actionMission: '대화할 때 눈 맞춤 연습하기', xpReward: 10, energyReward: 3 },
  { id: 'relationship-nonverbal-1-3', worldKey: 'relationship', chapterKey: 'nonverbal', level: 1, conceptTitle: '표정 관리', conceptContent: '표정은 감정을 전달합니다.\n\n긍정적인 표정이 좋은 인상을 줍니다.\n\n미소는 가장 쉬운 소통 도구입니다.', thinkingQuestion: '평소 어떤 표정을 짓나요?', actionMission: '대화할 때 부드러운 표정 유지하기', xpReward: 10, energyReward: 3 },

  // 발표력
  { id: 'relationship-presentation-1-1', worldKey: 'relationship', chapterKey: 'presentation', level: 1, conceptTitle: '발표의 시작', conceptContent: '발표는 준비가 반입니다.\n\n무엇을 말할지 미리 정리하세요.\n\n핵심 메시지 3가지로 압축하세요.', thinkingQuestion: '발표 전에 어떻게 준비하나요?', actionMission: '다음 발표 핵심 내용 3가지 정리하기', xpReward: 10, energyReward: 3 },
  { id: 'relationship-presentation-1-2', worldKey: 'relationship', chapterKey: 'presentation', level: 1, conceptTitle: '떨림 다루기', conceptContent: '발표 때 떨리는 건 자연스럽습니다.\n\n깊게 숨 쉬고, 천천히 시작하세요.\n\n몇 번 하면 점점 편해집니다.', thinkingQuestion: '발표할 때 많이 떨리나요?', actionMission: '발표 전 심호흡 3번 하기', xpReward: 10, energyReward: 3 },
  { id: 'relationship-presentation-1-3', worldKey: 'relationship', chapterKey: 'presentation', level: 1, conceptTitle: '청중과 연결하기', conceptContent: '발표는 일방적으로 말하는 게 아닙니다.\n\n청중을 보고, 반응을 살피세요.\n\n질문을 던지거나 이야기를 나누세요.', thinkingQuestion: '발표할 때 청중과 소통하나요?', actionMission: '발표 중 청중에게 질문 하나 던지기', xpReward: 10, energyReward: 3 },

  // 설득력
  { id: 'relationship-persuasion-1-1', worldKey: 'relationship', chapterKey: 'persuasion', level: 1, conceptTitle: '설득의 기본', conceptContent: '설득은 강요가 아닙니다.\n\n상대가 "그럴 수 있겠네"라고 느끼게 하는 것입니다.\n\n상대의 입장에서 이유를 설명하세요.', thinkingQuestion: '누군가를 설득해본 적 있나요?', actionMission: '상대 입장에서 이유 설명하기', xpReward: 10, energyReward: 3 },
  { id: 'relationship-persuasion-1-2', worldKey: 'relationship', chapterKey: 'persuasion', level: 1, conceptTitle: '근거 제시하기', conceptContent: '주장에는 근거가 있어야 합니다.\n\n"왜냐하면 ○○이기 때문이야"라고 말하세요.\n\n사실, 예시, 데이터가 설득력을 높입니다.', thinkingQuestion: '의견을 말할 때 이유를 말하나요?', actionMission: '의견에 근거 2가지 이상 붙이기', xpReward: 10, energyReward: 3 },
  { id: 'relationship-persuasion-1-3', worldKey: 'relationship', chapterKey: 'persuasion', level: 1, conceptTitle: '상대의 반대 예상하기', conceptContent: '좋은 설득은 반론을 미리 생각합니다.\n\n"이런 생각도 있겠지만..." 하고 인정한 후\n\n그래도 왜 내 주장이 맞는지 설명하세요.', thinkingQuestion: '상대의 반대 의견을 생각해보나요?', actionMission: '내 주장에 대한 반론 예상하고 답변 준비하기', xpReward: 10, energyReward: 3 },

  // 감정 표현
  { id: 'relationship-emotion-1-1', worldKey: 'relationship', chapterKey: 'emotion', level: 1, conceptTitle: '감정을 말로 표현하기', conceptContent: '감정은 말해야 전달됩니다.\n\n"나는 ○○해"라고 솔직하게 말하세요.\n\n표현하지 않으면 오해가 생깁니다.', thinkingQuestion: '감정을 잘 표현하나요?', actionMission: '오늘 느낀 감정을 말로 표현하기', xpReward: 10, energyReward: 3 },
  { id: 'relationship-emotion-1-2', worldKey: 'relationship', chapterKey: 'emotion', level: 1, conceptTitle: '나 전달법', conceptContent: '"너 때문에"가 아니라 "나는 ○○해"라고 말하세요.\n\n상대를 비난하지 않고 내 감정을 전할 수 있습니다.\n\n갈등을 줄이는 방법입니다.', thinkingQuestion: '감정을 표현할 때 상대를 탓하나요?', actionMission: '"나는 ~해" 형식으로 감정 표현하기', xpReward: 10, energyReward: 3 },
  { id: 'relationship-emotion-1-3', worldKey: 'relationship', chapterKey: 'emotion', level: 1, conceptTitle: '감정 조절하기', conceptContent: '감정은 표현하되, 조절도 필요합니다.\n\n화가 나면 잠시 멈추고 생각하세요.\n\n감정에 휘둘리지 않고 적절히 표현하세요.', thinkingQuestion: '감정이 격해지면 어떻게 하나요?', actionMission: '화나거나 슬플 때 3초 멈추기', xpReward: 10, energyReward: 3 },

  // 피드백
  { id: 'relationship-feedback-1-1', worldKey: 'relationship', chapterKey: 'feedback', level: 1, conceptTitle: '피드백 주기', conceptContent: '좋은 피드백은 구체적입니다.\n\n"잘했어" 대신 "이 부분이 잘했어"라고 말하세요.\n\n칭찬도, 개선점도 구체적으로 말하세요.', thinkingQuestion: '피드백을 줄 때 구체적으로 하나요?', actionMission: '구체적으로 피드백 주기', xpReward: 10, energyReward: 3 },
  { id: 'relationship-feedback-1-2', worldKey: 'relationship', chapterKey: 'feedback', level: 1, conceptTitle: '건설적 피드백', conceptContent: '비판만 하지 말고 대안을 제시하세요.\n\n"이건 별로야" 대신 "이렇게 하면 더 좋겠어"\n\n받는 사람이 발전할 수 있게 해주세요.', thinkingQuestion: '피드백 줄 때 대안을 함께 말하나요?', actionMission: '피드백에 대안 포함하기', xpReward: 10, energyReward: 3 },
  { id: 'relationship-feedback-1-3', worldKey: 'relationship', chapterKey: 'feedback', level: 1, conceptTitle: '피드백 받기', conceptContent: '피드백은 성장의 기회입니다.\n\n방어적으로 반응하지 말고 열린 마음으로 들으세요.\n\n"고마워, 참고할게"라고 말하세요.', thinkingQuestion: '피드백을 받으면 어떻게 반응하나요?', actionMission: '피드백 받으면 감사하다고 말하기', xpReward: 10, energyReward: 3 },
